...
_AUTO_NOTES = (
    ...
    "⏳ {names} спишеться сам {day}-го через monobank — ще в дорозі.",
    "⏳ За {names} не хвилюйтесь: autopay monobank {day}-го, чекаємо списання.",
    "⏳ Тільки {names} на черзі — monobank забере {day}-го автоматично.",
)
...
_GREETINGS = (
    ...
    "До ваших послуг. Папери в теках, чай гарячий — з чого почнемо?",
    "Вітаю. Все на місці, ніщо не горить. Чим прислужитися?",
    "Доброго дня. Я при справах і при спокої. Що сьогодні?",
    "Радий вас бачити. Рахунки полічені, дедлайни під наглядом. Слухаю.",
    "Вітаю. Комуналка не дрімає, але й не кусається. Що вас цікавить?",
    "На посту. Питайте про гроші, показники чи дедлайни — розберемо.",
    "Вітаю вас. Один тап чи одне слово — і я вже взявся. Що робимо?",
    "Доброго. Тут тихо й по-діловому. Чим можу прислужитися?",
)
